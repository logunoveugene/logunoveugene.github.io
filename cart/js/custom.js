...
var kolich = new Vue({
  ...
  methods: {
    ...
    addNew: function(index) {
          ...
          this.casemyToDel = this.filteredgifts[index].id;
      ...
      if (this.selectedPrivate.selectedGifts.length < this.giftcountset  && this.filteredgifts[index].clicked ==false ) {
      ...
      this.filteredgifts[index].clicked = !this.filteredgifts[index].clicked
    ...
    del: function(index) {
      ...
      this.casemy = this.selectedPrivate.selectedGifts[index].id;
      ...
      for (var i = 0; i < this.filteredgifts.length; i++) {
        if (this.filteredgifts[i].id == this.casemy) {
                this.filteredgifts[i].clicked = !this.filteredgifts[i].clicked
