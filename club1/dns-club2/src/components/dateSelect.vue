<template>
    ...
    <!--&lt;!&ndash;<a href="#" class="link link&#45;&#45;color-grey">Выбрать период</a>&ndash;&gt;-->
    <!--</div>-->
    <!--</template>-->
    <!--</v-popover>-->
    <div class="position-relative">
        <div class="">Дата и время публикации: <span  class="link link--color-blue link--doted" v-if="date!=''">{{date}}</span> <span v-if="date==''" class="link link--color-blue link--doted">выбрать</span></div>
        <flat-pickr
                v-model="date"
                @on-close="selectDate"
                :config="config"
