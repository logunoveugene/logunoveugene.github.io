...
export default class Main extends React.Component {
  ...
  handlePostData = () => {
    ...
    let contactsCount = firebase.database().ref(currentUser.uid + '/node')
    // let contactCountRef = event.data.ref.parent.child(contactsCount);
    return contactsCount.transaction(function (currentCount) {
