	...
	export default {
		...
		methods:    {
			issueReady() {
				...
				window.gtag('event', 'click', { 'event_category':'2020-02-27-test-ux', 'event_label': this.answer[0] +  ' , '+ this.answer[1] +  ' , '+ this.answer[2] +  ' , '+ this.answer[3] +  ' , '+ this.answer[4] +  ' , '+ this.answer[5] +' , '+  userAgent});
